    ...
    >
      <div className="max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row">
        <div className=" mt-14 md:mt-0 flex flex-col justify-center h-full">
          <h2 className="text-4xl sm:text-7xl font-bold text-white">I'm Front End Web Developer</h2>
          <p className="text-gray-500 py-4 max-w-md">
            Currently I'm fresh in Web Development field and I love to work on
            web applications using technologies like React, Tailwind and more.
          </p>
          <div>
